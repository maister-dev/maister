...
const AUTHED_SPEC =
  /.*(m11[abc]-.*|m12-evidence-graph|m13-assignments|m15-.*|m16-.*|m17-.*|m18-.*|m19-.*|m22-.*|m23-.*|m27-.*|portfolio-board|task-launch-gating|project-registration|admin-users|project-members|scratch-launch|platform-acp-runners|flows-authoring|run-schedules)\.spec\.ts$/;
