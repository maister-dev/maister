...
const PANEL_KEYS = [
  ...
  "warnings.note",
  "warnings.fact.head",
  "warnings.fact.targetHead",
  "warnings.fact.dirty",
  "warnings.fact.upstream",
  "warnings.fact.remotes",
  "warnings.fact.aheadBehind.base",
  "warnings.fact.aheadBehind.target",
  "warnings.fact.aheadBehind.published",
  "warnings.fact.unpushedCommits",
  "warnings.fact.publishedRemoteHead",
  "warnings.fact.reattachSources",
  "warnings.fact.rescueRefs",
  "warnings.fact.other",
  "cancel",
  "publicChip",
  "prChip",
  ...
  "update.remoteMoved",
  "update.divergedTitle",
  "update.divergedBody",
  "update.divergedPr",
  "update.divergedOnto",
  "update.divergedConfirm",
  "update.outcome.noop",
