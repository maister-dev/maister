...
// M33 (ADR-087) launch-verdict patch. The ext triage op uses the set-only
...
// Ext triage op (ADR-087 D8): set-only verdict fields + the 'triaged' stamp +
...
// "Send to triage" (ADR-087 D13): the task.triage_requeued emitter that
