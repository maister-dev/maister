...
export function buildNodeSideFormLabels(te: Translator): NodeSideFormLabels {
  ...
  return {
    ...
    consensus: {
      ...
      participantAgent: te("nodeForm.consensus.participantAgent"),
      participantRunner: te("nodeForm.consensus.participantRunner"),
      ...
      synthesizerAgent: te("nodeForm.consensus.synthesizerAgent"),
      synthesizerRunner: te("nodeForm.consensus.synthesizerRunner"),
