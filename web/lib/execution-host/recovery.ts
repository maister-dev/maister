...
// ADR-164 D5 W2/W4: fold a host receipt into the ledger together with the
...
// ADR-164 D5 crash windows W1/W2/W4 — startup and the periodic sweep pass.
...
// ADR-164 sweep backstop (V5): an `active` assignment whose run has no live
