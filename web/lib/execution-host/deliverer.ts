...
// ADR-164 D5: per-kind delivery policy — a data table, never a switch (OCP).
...
// ADR-164 D4/D5 for IMMEDIATE kinds: claim → wire → ack. Unknown-outcome
...
// ADR-164 D5 for `session.prompt`: the long-lived HTTP response, the SSE
