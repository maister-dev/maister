...
beforeAll(async () => {
  ...
  testDatabase = await startMainPostgresTestDb({
    databaseName: "ext_promote_rework_test",
  });
...
beforeEach(async () => {
  ...
  // walks during the rework respawn: an attached, trusted, Installed
  // package_install at the agent .md root (primary project only — the
  // cross-project case refuses at the route's projectId predicate first).
