...
describe("HITL respond route — kind=permission", () => {
  ...
  // ADR-166 I1: the `session.input` command is queued inside the Phase-1 claim
  ...
  // ADR-166 I2: a definitive 503 leaves respondedAt NULL; the user's retry
  ...
  // ADR-166 I4: a delivery that fails terminally releases the live deferred
