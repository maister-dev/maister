...
// supervisor. After the supervisor acks, refresh stored readiness from fresh
// diagnostics so a CCR-backed runner becomes launchable without waiting for the
// next admin /settings load.
