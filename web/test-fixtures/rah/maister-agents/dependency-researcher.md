...
description: Read-only dependency researcher for the RAH reference harness.
workspace: repo_read
mode: session
triggers:
  - manual
risk_tier: read_only
---
Investigate the dependency question you were given against the checked-out repository.
