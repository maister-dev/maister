...
const labels: FlightCardLabels = {
  ...
  workStage: {
    ...
    Queued: "Queued",
    Executing: "Executing",
    WaitingOnHuman: "Waiting on a human",
    Review: "Review",
    Crashed: "Crashed",
    Promoted: "Promoted",
    Abandoned: "Abandoned",
...
describe("FlightCard — PR-state chip (ADR-140)", () => {
  ...
  it("renders the conflicts variant with a LIVE reopen action when prHasConflicts (ADR-141 Task 17)", () => {
    const html = render(
