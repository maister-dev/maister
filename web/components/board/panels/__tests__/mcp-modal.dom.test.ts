...
// still SUBMITTED. A warning that blocked would be a refusal in disguise.
...
import { ProjectMcpModal } from "@/components/board/panels/mcp-modal";

(
  globalThis as { IS_REACT_ACT_ENVIRONMENT?: boolean }
).IS_REACT_ACT_ENVIRONMENT = true;

// The modal reads labels through `useTranslations("mcpPanel")`; echo the key so
