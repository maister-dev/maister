...
**Status:** Implemented host registry, reserve/upload/delete routes and manager catalog; **Designed** lifecycle convergence, safe content delivery, read integrity and fair retention corrections (AB-09/12–15). Bytes remain host-owned and manager locators remain opaque.
