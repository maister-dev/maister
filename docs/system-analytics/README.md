...
| Execution hosts | [`execution-hosts.md`](execution-hosts.md) | Local execution-host contract (ADR-164, Designed): durable supervisor host identity + registration policy, per-run epoch-fenced execution assignments, the host-bound command envelope/ledger/receipts FSM, opaque adopted-workspace handles, web-crash and supervisor-restart recovery, legacy backfill. |
