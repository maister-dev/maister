...
| Review comments | [`review-comments.md`](review-comments.md) | Line-anchored review threads on the gate diff, placement, rework compose into `commentsVar`, loop-exhaustion guard (ADR-071). |
