...
| Social board | [`social-board.md`](social-board.md) | `KEY-N` comments with mention expansion, domain-written activity, subscriptions, per-recipient inbox, polymorphic actor pair (ADR-075). |
