...
> state-aware command/receipt retirement). Native AB-09 is qualified in S3.1 and
> AB-12 in S3.4; AB-16 has a qualified S5.1/S5.2 core. AB-11/13–15/17 and the
> remaining AB-16 matrix stay Designed for S3–S5. Decision:
