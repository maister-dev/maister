...
| **R12 / AB-12** Safe untrusted downloads (OBJ-02/07) | Central safe attachment header policy on direct/proxy content paths, safe filename encoding and existing response-data authorization. No active MIME inline. | O; S0 (can start independently) | **AT-12**, real authorized browser opens HTML/SVG artifacts; no script or authenticated side effect; positive authorized download and foreign/unauthorized denial. | Designed |
