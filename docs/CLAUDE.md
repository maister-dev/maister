...
| [`system-analytics/review-comments.md`](system-analytics/review-comments.md) | Line-anchored review-comment threads on the gate diff: placement, rework compose into `commentsVar`, loop-exhaustion guard (Designed — ADR-071). |
