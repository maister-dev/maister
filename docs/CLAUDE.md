...
| [`system-analytics/execution-policy.md`](system-analytics/execution-policy.md) | Flow execution-control policy (ADR-094, Implemented): preset + 9 composable autonomy axes (A self-correction / B escalation / C output shaping), immutable launch snapshot, fail-closed resolvers, no-blind-ship guard. |
