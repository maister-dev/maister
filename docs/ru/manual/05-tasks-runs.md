...
| Failed | Агент завершился с ошибкой без пути восстановления; прогон остаётся в портфеле и в меню карточки на доске, его работу можно сохранить через git-панель |
