...
действия. Когда прогон остановлен, действия с рабочей копией — коммит,
публикация, обновление, PR — собраны в git-панели; см.
[Проверка результата и слияние](07-review.md).
...
| Failed | Агент завершился с ошибкой без пути восстановления; прогон остаётся в портфеле и в меню карточки на доске, его работу можно сохранить через git-панель. Как и у завершённого прогона, рабочая копия удаляется сборкой мусора через `MAISTER_GC_AGE_DAYS` дней (в панели виден обратный отсчёт), но сначала сохраняется в архивную ссылку — «Вернуть рабочую копию» восстановит её |
