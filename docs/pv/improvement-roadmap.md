...
| **Flow & intake expansion** | More Flow templates; deeper Gemini/OpenCode/MiMo ACP proof for permissions, MCP, model switching, and resume; CI/log intake + external board sync (gated on draft/publish/dedup/severity/cooldown) (`PRODUCT_VIEW.md` §Phase 2.7) |
