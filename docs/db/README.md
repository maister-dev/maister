...
| [`attention-domain.md`](attention-domain.md) | Attention plane: per-user activity read cursor + notification/web-push subscriptions (ADR-168/172, migrations `0162`–`0163`, Designed). |
