...
docs/screens/
  ...
  projects/          # project onboarding + settings surfaces
    project-board.md # /projects/:slug board + card editing
...
| [`admin/execution-host.md`](admin/execution-host.md) | Execution-host and event-plane diagnostics (admin) | `/admin/execution-host` | Designed (P0-7) |
