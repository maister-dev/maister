...
| [`2026-09-21-mcp-configurator-env-model-design.md`](2026-09-21-mcp-configurator-env-model-design.md) | Design (2026-09-21) — env/header value maps, overlay as source remap, host env-ref readiness, codex transport gate; open points §11 |
