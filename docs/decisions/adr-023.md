...
- 2026-09-02 — [ADR-166](adr-166.md) (Stage A execution-host contract) records
  ...
  Postgres-only.
- 2026-09-04 — [ADR-167](adr-167.md) removes shared runtime-data authority:
  Postgres owns canonical events and metadata, while host files are available
  only through opaque typed object contracts. Repository and worktree
  operations remain co-located for Stage C.
