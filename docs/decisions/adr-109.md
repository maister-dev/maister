...
**2026-09-23 amendment (Designed; P0-5 v2):** Consensus evidence delivery is
...
remain unchanged. New metadata uses existing JSON rows. No migration, new
table/column, supervisor change, or engine-version bump follows from this
amendment. The protocol and crash windows are specified in
[consensus analytics](../system-analytics/consensus.md#p0-5-v2-execution-contract-designed-acceptance-before-implemented).
