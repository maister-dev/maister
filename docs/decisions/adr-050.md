...
> **2026-09-02:** [ADR-164](adr-164.md) removes the router-sidecar layer. The
> platform runner and code-owned adapter decisions remain in force.

> **Supersedes (in part) [ADR-004](adr-004.md) and [ADR-005](adr-005.md):**
> this ADR replaces the project-scoped executor-identity + model-routing config
> those defined.
