...
> **Historical migration note:** CCR references below describe the 2026-06-16
> schema sequence. Managed CCR support and its schema were removed by
> [ADR-164](adr-164.md) and migration 0128. The local-package decision remains
> implemented.
