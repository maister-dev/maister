...
project:
  ...
  public_branch_template: feature/{task_key}-{slug} # ADR-181 (Designed); the default
...
| `MAISTER_GC_ARCHIVE_PUSH`                      | no                                                                   | `false`                                                           | Web: push the `maister/archive/<runId>` branch to the remote during GC preserve **and** (ADR-181, Designed) operator archive/drop                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
