...
- [ ] **T4.1 Flow launch + runner-agent + runner-graph.**
...
- [ ] **T4.2 HITL respond + keepalive sweeper + hook-trip + node-interrupt + budget paths.**
...
- [ ] **T4.3 Resume / recover / resume-driver / resume-recovery / rework return / wait-resume.**
...
- [ ] **T4.4 Scratch runs + local-package assistant + gate-chat + agent-question.**
...
- [ ] **T4.5 Platform agents + consensus draft + branch-sync + evaluations + workbench lifecycle + GC + reconcile.**
...
- [ ] **T4.6 Admin/diagnostic surfaces + lint fence.**
