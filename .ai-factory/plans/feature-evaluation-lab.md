...
- 0111_evaluation_legacy_contract (RESERVED — deferred contract/drop migration after the rollback window; NOT implemented in M46/M47/M48; moved from 0110, which M48 T7.2 claimed for the suite tables).
