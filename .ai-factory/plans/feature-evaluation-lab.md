...
- 0110_evaluation_legacy_contract (RESERVED — deferred contract/drop migration after the rollback window; NOT implemented in M46/M47; moved from 0109, which M47 T6.3 claimed for the launch-batch tables).
